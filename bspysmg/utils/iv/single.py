# @TODO: This file corresponds to the old setups, needs to be updated accordin to new configuration dictionaries
# It is should also not use get_instrument, but hardwae processor. instead
import numpy as np
import matplotlib.pyplot as plt
from brainspy.instruments.instrument_mgr import get_instrument
